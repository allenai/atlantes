...
OBVIOUS_TRANSITING_DATA_FOLDER = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/obvious-transiting-tracks").replace(f"gs://{GCP_TEST_BUCKET}/", "")
OBVIOUS_MOORED_DATA_FOLDER = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/obvious-moored-tracks").replace(f"gs://{GCP_TEST_BUCKET}/", "")
OBVIOUS_ANCHORED_DATA_FOLDER = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/obvious-anchored-tracks").replace(f"gs://{GCP_TEST_BUCKET}/", "")
NEAR_SHORE_DATA_FOLDER = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/near-shore-tracks").replace(f"gs://{GCP_TEST_BUCKET}/", "")
NON_FISHING_NON_UNKNOWN_FOLDER = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/non-fishing-non-unknown-ves-tracks").replace(f"gs://{GCP_TEST_BUCKET}/", "")
OBVIOUS_STATIONARY_DATA_FOLDER = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/stationary-vessel-tracks").replace(f"gs://{GCP_TEST_BUCKET}/", "")
TRANSITING_DF_FOLDER = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/transiting-vessel-tracks").replace(f"gs://{GCP_TEST_BUCKET}/", "")
FISHING_DATA_FOLDER = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/fishing-vessel-tracks").replace(f"gs://{GCP_TEST_BUCKET}/", "")
HIGH_TRAFFIC_PORTS = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/high-traffic-port-tracks").replace(f"gs://{GCP_TEST_BUCKET}/", "")
MARINE_INFRA_SUPPLY_VESSELS = os.path.join(TEST_PROJECTS_FOLDER_PREFIX, "test-data/offshore_marine_infra_transiting_df_list").replace(f"gs://{GCP_TEST_BUCKET}/", "")
